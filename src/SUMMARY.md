...
- [A shared deck is not showing images/playing audio](./a-shared-deck-is-not-showing-imagesplaying-audio.md)
- [Anki 2.0 add-ons](./anki-20-add-ons.md)
- [Anki 2.0 support has ended](./anki-20-support-has-ended.md)
- [Anki failing to start on some Windows 7/8 machines](./anki-failing-to-start-on-some-windows-78-machines.md)
...
- [AnkiMobile interface language](./ankimobile-interface-language.md)
...
- [Outlook.com silently discards email](./outlookcom-silently-discards-email.md)
...
- [Some updates were ignored because note type has changed](./some-updates-were-ignored-because-note-type-has-changed.md)
...
- [When Anki doesn't start on Windows (debugging steps)](./when-anki-doesnt-start-on-windows-debugging-steps.md)
